...
#define CONVERT_TO_SIMD_MASK_TYPE(x)	static_cast<SIMD_MASK_TYPE>(x)
#else
...
#define SIMD_CMP_EPI8(a,b)	CONVERT_TO_SIMD_MASK_TYPE(_mm512_cmpeq_epi8_mask(a,b))
...
#define SIMD_CMP_EPI8(a,b)	CONVERT_TO_SIMD_MASK_TYPE(_mm256_movemask_epi8(_mm256_cmpeq_epi8(a,b)))
