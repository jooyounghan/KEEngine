...
namespace ke
{
	...
	BEGIN_BIND_REFLECT_PROPERTY(RasterizerState)
		BIND_REFLECT_POD_PROPERTY(RasterizerState, EFillMode, _fillMode, EReflectUIOption::Editable, EFillMode::Solid);
		BIND_REFLECT_POD_PROPERTY(RasterizerState, ECullMode, _cullMode, EReflectUIOption::Editable, ECullMode::Back);
		BIND_REFLECT_POD_PROPERTY(RasterizerState, bool, _frontCounterClockwise, EReflectUIOption::Editable, false);
		...
		BIND_REFLECT_POD_PROPERTY(RasterizerState, bool, _depthClipEnable, EReflectUIOption::Editable, true);
		BIND_REFLECT_POD_PROPERTY(RasterizerState, bool, _multisampleEnable, EReflectUIOption::Editable, false);
		BIND_REFLECT_POD_PROPERTY(RasterizerState, bool, _antialiasedLineEnable, EReflectUIOption::Editable, false);
		BIND_REFLECET_POD_RANGED_PROPERTY(RasterizerState, uint32, _forcedSampleCount, EReflectUIOption::Editable, 0, 16, 1, 0);
		BIND_REFLECT_POD_PROPERTY(RasterizerState, EConservativeRasterizationMode, _conservativeRaster, EReflectUIOption::Editable, EConservativeRasterizationMode::Off);
