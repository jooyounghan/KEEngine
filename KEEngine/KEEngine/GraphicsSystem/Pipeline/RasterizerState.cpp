...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(RasterizerState)
		DEFINE_REFLECT_POD_PROPERTY(RasterizerState, _fillMode)
		DEFINE_REFLECT_POD_PROPERTY(RasterizerState, _cullMode)
		...
		DEFINE_REFLECT_POD_PROPERTY(RasterizerState, _conservativeRaster)
	END_DEFINE_REFLECT_PROPERTY()

	BEGIN_BIND_REFLECT_PROPERTY(RasterizerState)
		BIND_REFLECET_POD_RANGED_PROPERTY(RasterizerState, uint8, _fillMode, EReflectUIOption::Editable, 0, 3, 1, 0);
		BIND_REFLECET_POD_RANGED_PROPERTY(RasterizerState, uint8, _cullMode, EReflectUIOption::Editable, 0, 3, 1, 0);
		...
		BIND_REFLECET_POD_PROPERTY(RasterizerState, bool, _depthClipEnable, EReflectUIOption::Editable, false);
		...
		BIND_REFLECET_POD_RANGED_PROPERTY(RasterizerState, uint8, _conservativeRaster, EReflectUIOption::Editable, 0, 1, 1, 0);
