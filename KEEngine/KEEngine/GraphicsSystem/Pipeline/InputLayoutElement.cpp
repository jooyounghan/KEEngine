...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(InputLayoutElement)
		...
		DEFINE_REFLECT_POD_PROPERTY(InputLayoutElement, _format)
		...
		DEFINE_REFLECT_POD_PROPERTY(InputLayoutElement, _inputSlotClass)
	...
	BEGIN_BIND_REFLECT_PROPERTY(InputLayoutElement)
		...
		BIND_REFLECET_POD_RANGED_PROPERTY(InputLayoutElement, uint8, _format, EReflectUIOption::Editable, 0, 255, 1, 0);
		...
		BIND_REFLECET_POD_RANGED_PROPERTY(InputLayoutElement, uint8, _inputSlotClass, EReflectUIOption::Editable, 0, 1, 1, 0);
