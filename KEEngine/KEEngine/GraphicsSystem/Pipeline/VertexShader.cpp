...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(VertexShader)
		DEFINE_REFLECT_PROPERTY(VertexShader, std::string, _shaderPath)
	...
	BEGIN_BIND_REFLECT_PROPERTY(VertexShader)
		BIND_REFLECT_PROPERTY(VertexShader, std::string, _shaderPath, EReflectUIOption::Editable, std::string(""));
