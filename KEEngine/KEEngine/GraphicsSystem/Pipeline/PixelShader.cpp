...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(PixelShader)
		DEFINE_REFLECT_PROPERTY(PixelShader, FlyweightStringA, _shaderPath)
	...
	BEGIN_BIND_REFLECT_PROPERTY(PixelShader)
		BIND_REFLECT_PROPERTY(PixelShader, FlyweightStringA, _shaderPath, EReflectUIOption::Editable);
