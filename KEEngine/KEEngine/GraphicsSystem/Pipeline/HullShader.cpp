...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(HullShader)
		DEFINE_REFLECT_PROPERTY(HullShader, FlyweightStringA, _shaderPath)
	...
	BEGIN_BIND_REFLECT_PROPERTY(HullShader)
		BIND_REFLECT_PROPERTY(HullShader, FlyweightStringA, _shaderPath, EReflectUIOption::Editable);
