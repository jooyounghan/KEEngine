...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(GeometryShader)
		DEFINE_REFLECT_PROPERTY(GeometryShader, FlyweightStringA, _shaderPath)
	...
	BEGIN_BIND_REFLECT_PROPERTY(GeometryShader)
		BIND_REFLECT_PROPERTY(GeometryShader, FlyweightStringA, _shaderPath, EReflectUIOption::Editable);
