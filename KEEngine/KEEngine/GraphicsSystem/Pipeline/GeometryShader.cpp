...
namespace ke
{
	BEGIN_DEFINE_REFLECT_PROPERTY(GeometryShader)
		DEFINE_REFLECT_PROPERTY(GeometryShader, std::string, _shaderPath)
	...
	BEGIN_BIND_REFLECT_PROPERTY(GeometryShader)
		BIND_REFLECT_PROPERTY(GeometryShader, std::string, _shaderPath, EReflectUIOption::Editable, std::string(""));
