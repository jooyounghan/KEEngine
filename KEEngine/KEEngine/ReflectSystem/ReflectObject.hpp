...
#define DEFINE_REFLECT_ENUM_SEQ_PROPERTY(ObjectType, Variable) { reflectMetaData.addReflectEnumSeqProperty(DEFINE_REFLECT_PROPERTY_PARAMETER(ObjectType, Variable)); }
